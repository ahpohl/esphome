...
from esphome.const import CONF_BATTERY_LEVEL, CONF_MAC_ADDRESS, UNIT_PERCENT, ICON_BATTERY, \
    CONF_WEIGHT, UNIT_KILOGRAM, ICON_SCALE, UNIT_OHM, CONF_IMPEDANCE, ICON_OMEGA, CONF_ID


DEPENDENCIES = ['esp32_ble_tracker']
AUTO_LOAD = ['xiaomi_ble']
xiaomi_xmtzc0xhm_ns = cg.esphome_ns.namespace('xiaomi_xmtzc0xhm')
XiaomiXMTZC0XHM = xiaomi_xmtzc0xhm_ns.class_('XiaomiXMTZC0XHM', esp32_ble_tracker.ESPBTDeviceListener,
                                             cg.Component)
